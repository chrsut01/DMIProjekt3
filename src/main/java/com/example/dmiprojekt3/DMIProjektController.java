...
public class DMIProjektController {
        ...
        public void initialize() {
                ...
                // private void getWeatherDataTry();
                        ...
                        while (rs.next()) {
                               ...
                               // rs.getString(1);
                                ...
                                if (columnValue.length() != 0)
                                   series.getData().add(new XYChart.Data(dato + " " + tid, Double.parseDouble(columnValue)));
